...
from core.loss import JointsMSELoss, NMTCritierion, NMTNORMCritierion, KLDiscretLoss, JointEdgeSegLoss, CrossEntropy
from core.function import validate_heatmap, validate_heatmap2,validate_heatmap_miou, validate_simdr, validate_sa_simdr,validate_sa_simdr4
...
def main():
    ...
    if cfg.LOSS.TYPE == 'JointsMSELoss':
        ...
        criterion2 = CrossEntropy().cuda()
        # criterion2 = JointEdgeSegLoss(classes=2,
        #                                  ignore_index=255,
    ...
    if cfg.MODEL.COORD_REPRESENTATION == 'simdr':
        ...
        # validate_heatmap2(cfg, valid_loader, valid_dataset, model, criterion,
        #      final_output_dir, tb_log_dir)
        perf_indicator,mean_IoU, IoU_array, pixel_acc, mean_acc = validate_heatmap_miou(cfg, valid_loader, valid_dataset, model, criterion,
             final_output_dir, tb_log_dir)
        print({mean_IoU})
        print(IoU_array)
        print(pixel_acc)
