...
from dataset.JointsDataset2 import JointsDataset2
from dataset.JointsDataset2 import JointsDataset3
...
class COCODataset2(JointsDataset2):
    '''
    "keypoints": {
        0: "nose",
        1: "left_eye",
...
class COCODataset3(JointsDataset3):
    '''
    "keypoints": {
        0: "nose",
        1: "left_eye",
