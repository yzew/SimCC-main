...
class PoseHighResolutionNet(nn.Module):
    ...
    def forward(self, x, mask):
        ...
        y_list[0] = self.cbam32(torch.cat((self.conv31(y_list[0]),x1),1))
        y_list[1] = self.cbam64(torch.cat((self.conv63(y_list[1]),x2),1))
        y_list[2] = self.cbam128(torch.cat((self.conv127(y_list[2]),x3),1))
