...
class PoseHighResolutionNet(nn.Module):
    def __init__(self, cfg, **kwargs):
        ...
        self.aspp = _AtrousSpatialPyramidPoolingModule(224, 45,
                                                       output_stride=8)
        self.bot_aspp = nn.Conv2d(225, 256, kernel_size=1, bias=False)
...
#######################################################################################################################
        ...
        #print(seg_x[0].shape) torch.Size([2, 32, 64, 48])
        ...
        # implementation of body generation part
        seg_body, seg_edge = self.squeeze_body_edge(aspp) # input 256  
        ...
        '''
        print(seg_final_out.shape)
        print(seg_body_out.shape)
        print(seg_edge_out.shape)
        torch.Size([2, 2, 256, 192])
        torch.Size([2, 2, 256, 192])
        ...
        if self.coord_representation == 'heatmap2':
            return x_, seg_final_out, seg_body_out, seg_edge_out
