...
import sys 
sys.path.append("..") 
from core.CoordConv import CoordConv,CoordConv2
...
class PoseHighResolutionNet(nn.Module):
    def __init__(self, cfg, **kwargs):
        ...
        #self.mlpp = nn.Linear(3072, 256, bias=False)
        # self.mlpp = nn.Sequential(
        #                 CoordConv(17, 17, 256),
        #                 ScaleNorm(256)
        # )
        ...
        # stem net
        self.coordconv = CoordConv2(3, 64, kernel_size=3, stride=2, padding=1, bias=False)
